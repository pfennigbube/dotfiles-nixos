...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/11b3717a-7e2a-4bbc-8a50-aa140c1bbff6";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/5794-D5CA";
      fsType = "vfat";
    };
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/ec72e7b6-d5c9-4900-81a0-9cba1fcc9904"; }
    ];
